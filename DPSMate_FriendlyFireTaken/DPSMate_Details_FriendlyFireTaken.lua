...
function DPSMate.Modules.DetailsFFT:UpdateDetails(obj, key)
	DPSMate_Details_CompareFFT:Hide()
	DPSMate_Details_CompareFFT_Graph:Hide()
	...
	DPSMate_Details_FFT:SetScale((DPSMateSettings["targetscale"] or 0.58)/UIParent:GetScale())
end

function DPSMate.Modules.DetailsFFT:UpdateCompare(obj, key, comp)
	self:UpdateDetails(obj, key)
	
	DPSMate_Details_CompareFFT.proc = "None"
	--UIDropDownMenu_SetSelectedValue(DPSMate_Details_CompareEDD_DiagramLegend_Procs, "None")
	DetailsUserComp = comp
	DPSMate_Details_CompareFFT_Title:SetText(DPSMate.L["fftby"]..comp)
	...
	if not g3 then
		g3=DPSMate.Options.graph:CreateStackedGraph("FFTStackedGraphComp",DPSMate_Details_CompareFFT_DiagramLine,"CENTER","CENTER",0,0,850,230)
		...
		g3:SetXLabels(true)
		g4=DPSMate.Options.graph:CreateGraphLine("FFTLineGraphComp",DPSMate_Details_CompareFFT_DiagramLine,"CENTER","CENTER",0,0,850,230)
		g7=DPSMate.Options.graph:CreateGraphLine("FFTLineGraphSumComp",DPSMate_Details_CompareFFT_Graph,"CENTER","CENTER",0,0,1750,230)
	end
	...
	DPSMate_Details_CompareFFT:Show()
	DPSMate_Details_CompareFFT_Graph:Show()
end

function DPSMate.Modules.DetailsFFT:UpdateSumGraph()
...
function DPSMate.Modules.DetailsFFT:ScrollFrame_Update(comp)
	if not comp then comp = DPSMate_Details_FFT.LastScroll or "" end
	local line, lineplusOffset
	local path = "DPSMate_Details_"..comp.."FFT_LogCreature"
...
function DPSMate.Modules.DetailsFFT:SelectCreatureButton(i, comp)
	if not comp then comp = DPSMate_Details_FFT.LastScroll or "" end
	local line, lineplusOffset
	local path = "DPSMate_Details_"..comp.."FFT_Log"
	local obj = _G(path.."_ScrollFrame")
	local uArr, dArr, dTot, dSel = DetailsArr, DmgArr, DetailsTotal, DetailsSelected
	if comp ~= "" and comp~=nil then
		uArr = DetailsArrComp
		dArr = DmgArrComp
		dTot = DetailsTotalComp
		DetailsSelectedComp = i+FauxScrollFrame_GetOffset(_G("DPSMate_Details_"..comp.."FFT_LogCreature_ScrollFrame"))
		dSel = DetailsSelectedComp
	else
		DetailsSelected = i+FauxScrollFrame_GetOffset(_G("DPSMate_Details_"..comp.."FFT_LogCreature_ScrollFrame"))
	...
	for p=1, 10 do
		_G("DPSMate_Details_"..comp.."FFT_LogCreature_ScrollButton"..p.."_selected"):Hide()
	end
	_G("DPSMate_Details_"..comp.."FFT_LogCreature_ScrollButton"..i.."_selected"):Show()
...
function DPSMate.Modules.DetailsFFT:SelectDetailsButton(p,i, comp, cname)
	if not comp then comp = DPSMate_Details_FFT.LastScroll or "" end
	local obj = _G("DPSMate_Details_"..comp.."FFT_Log_ScrollFrame")
	local lineplusOffset = i + FauxScrollFrame_GetOffset(obj)
	local uArr, dArr, dSel = DetailsArr, DmgArr, DetailsSelected
	
	for p=1, 10 do
		_G("DPSMate_Details_"..comp.."FFT_Log_ScrollButton"..p.."_selected"):Hide()
	end
	...
	-- Hit
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount2_Amount"):SetText(hit)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount2_Percent"):SetText(strformat("%.1f", 100*hit/total).."%")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount2_StatusBar"):SetValue(ceil(100*hit/max))
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount2_StatusBar"):SetStatusBarColor(0.9,0.0,0.0,1)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Average2"):SetText(ceil(hitav/DPSMate:ProbZero(hit)))
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Min2"):SetText(hitMin)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Max2"):SetText(hitMax)
	
	-- Crit
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount3_Amount"):SetText(crit)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount3_Percent"):SetText(strformat("%.1f", 100*crit/total).."%")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount3_StatusBar"):SetValue(ceil(100*crit/max))
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount3_StatusBar"):SetStatusBarColor(0.0,0.9,0.0,1)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Average3"):SetText(ceil(critav/DPSMate:ProbZero(crit)))
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Min3"):SetText(critMin)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Max3"):SetText(critMax)
	
	-- Miss
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount4_Amount"):SetText(miss)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount4_Percent"):SetText(strformat("%.1f", 100*miss/total).."%")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount4_StatusBar"):SetValue(ceil(100*miss/max))
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount4_StatusBar"):SetStatusBarColor(0.0,0.0,1.0,1)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Average4"):SetText("-")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Min4"):SetText("-")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Max4"):SetText("-")
	
	-- Parry
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount5_Amount"):SetText(parry)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount5_Percent"):SetText(strformat("%.1f", 100*parry/total).."%")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount5_StatusBar"):SetValue(ceil(100*parry/max))
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount5_StatusBar"):SetStatusBarColor(1.0,1.0,0.0,1)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Average5"):SetText("-")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Min5"):SetText("-")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Max5"):SetText("-")
	
	-- Dodge
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount6_Amount"):SetText(dodge)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount6_Percent"):SetText(strformat("%.1f", 100*dodge/total).."%")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount6_StatusBar"):SetValue(ceil(100*dodge/max))
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount6_StatusBar"):SetStatusBarColor(1.0,0.0,1.0,1)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Average6"):SetText("-")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Min6"):SetText("-")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Max6"):SetText("-")
	
	-- Resist
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount7_Amount"):SetText(resist)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount7_Percent"):SetText(strformat("%.1f", 100*resist/total).."%")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount7_StatusBar"):SetValue(ceil(100*resist/max))
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Amount7_StatusBar"):SetStatusBarColor(0.0,1.0,1.0,1)
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Average7"):SetText("-")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Min7"):SetText("-")
	_G("DPSMate_Details_"..comp.."FFT_LogDetails_Max7"):SetText("-")
end

function DPSMate.Modules.DetailsFFT:UpdateLineGraph(gg, comp, cname)
	if g then
		g:Hide()
	end
	if g3 then
...
function DPSMate.Modules.DetailsFFT:UpdateStackedGraph(gg, comp, cname)
	if g2 then
		g2:Hide()
	end
	if g4 then
	...
	if toggle3 then
		...
		for cat, val in db[DPSMateUser[cname or DetailsUser][1]] do
			if DPSMate:TContains(uArr,cat) then
				for ca, va in val do
...
function DPSMate.Modules.DetailsFFT:CreateGraphTable(comp)
	local lines = {}
	comp = comp or ""
	for i=1, 8 do
		-- Horizontal
		lines[i] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."FFT_Log"), 252, 270-i*30, 617, 270-i*30, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
		lines[i]:Show()
	end
	-- Vertical
	lines[9] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."FFT_Log"), 302, 260, 302, 15, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[9]:Show()
	
	lines[10] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."FFT_Log"), 437, 260, 437, 15, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[10]:Show()
	
	lines[11] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."FFT_Log"), 497, 260, 497, 15, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[11]:Show()
	
	lines[12] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."FFT_Log"), 557, 260, 557, 15, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[12]:Show()
end

function DPSMate.Modules.DetailsFFT:SortLineTable(arr, b, cname)
	local newArr = {}
	if b then
...
function DPSMate.Modules.DetailsFFT:GetSummarizedTable(arr,b,cname)
