...
function DPSMate.Modules.DetailsDispelsReceived:UpdateDetails(obj, key)
	DPSMate_Details_CompareDispelsReceived:Hide()

	curKey = key
	db, cbt = DPSMate:GetMode(key)
	DetailsUser = obj.user
	DetailsUserComp = nil
	DPSMate_Details_DispelsReceived_Title:SetText(DPSMate.L["dispelsreceivedby"]..obj.user)
...
function DPSMate.Modules.DetailsDispelsReceived:UpdateCompare(obj, key, comp)
	...
	DPSMate_Details_CompareDispelsReceived_Title:SetText(DPSMate.L["dispelsreceivedby"]..comp)
	DetailsArrComp, DetailsTotalComp, DmgArrComp = self:EvalTable(comp)
	DPSMate_Details_CompareDispelsReceived:Show()
	self:ScrollFrame_Update("Compare")
	self:SelectCreatureButton(1,"Compare")
	self:SelectCreatureAbilityButton(1,1,"Compare")
end

function DPSMate.Modules.DetailsDispelsReceived:EvalTable(cname)
...
function DPSMate.Modules.DetailsDispelsReceived:ScrollFrame_Update(comp)
	comp = comp or DPSMate_Details_DispelsReceived.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."DispelsReceived_Log_ScrollFrame")
	local path = "DPSMate_Details_"..comp.."DispelsReceived_Log_ScrollButton"
...
function DPSMate.Modules.DetailsDispelsReceived:SelectCreatureButton(i, comp)
	comp = comp or DPSMate_Details_DispelsReceived.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."DispelsReceived_LogTwo_ScrollFrame")
	i = i or obj.index
	obj.index = i
	local path = "DPSMate_Details_"..comp.."DispelsReceived_LogTwo_ScrollButton"
	local uArr, dArr, dTot, dSel = DetailsArr, DmgArr, DetailsTotal, DetailsSelected
	if comp ~= "" and comp then
		uArr = DetailsArrComp
		dArr = DmgArrComp
	...
	for p=1, 14 do
		_G("DPSMate_Details_"..comp.."DispelsReceived_Log_ScrollButton"..p.."_selected"):Hide()
	end
	_G(path.."1_selected"):Show()
	DPSMate.Modules.DetailsDispelsReceived:SelectCreatureAbilityButton(i, 1, comp)
	_G("DPSMate_Details_"..comp.."DispelsReceived_Log_ScrollButton"..i.."_selected"):Show()
end

function DPSMate.Modules.DetailsDispelsReceived:SelectCreatureAbilityButton(i, p, comp)
	comp = comp or DPSMate_Details_DispelsReceived.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."DispelsReceived_LogThree_ScrollFrame")
	i = i or _G("DPSMate_Details_"..comp.."DispelsReceived_LogTwo_ScrollFrame").index
	p = p or obj.index
	obj.index = p
	local path = "DPSMate_Details_"..comp.."DispelsReceived_LogThree_ScrollButton"
	local uArr, dArr, dTot, dSel = DetailsArr, DmgArr, DetailsTotal, DetailsSelected
	if comp ~= "" and comp then
		uArr = DetailsArrComp
		dArr = DmgArrComp
	...
	for i=1, 14 do
		_G("DPSMate_Details_"..comp.."DispelsReceived_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	_G("DPSMate_Details_"..comp.."DispelsReceived_LogTwo_ScrollButton"..p.."_selected"):Show()
end