...
function DPSMate.Modules.DetailsLiftMagicReceived:UpdateDetails(obj, key)
	DPSMate_Details_CompareLiftMagicReceived:Hide()
	...
	DPSMate_Details_LiftMagicReceived:SetScale((DPSMateSettings["targetscale"] or 0.58)/UIParent:GetScale())
end

function DPSMate.Modules.DetailsLiftMagicReceived:UpdateCompare(obj, key, comp)
	self:UpdateDetails(obj, key)
	
	DetailsUserComp = comp
	DPSMate_Details_CompareLiftMagicReceived_Title:SetText(DPSMate.L["magicliftof"]..comp)
	DetailsArrComp, DetailsTotalComp, DmgArrComp = self:EvalTable(comp)
	DPSMate_Details_CompareLiftMagicReceived:Show()
	self:ScrollFrame_Update("Compare")
	self:SelectCreatureButton(1,"Compare")
	self:SelectCreatureAbilityButton(1,1,"Compare")
end

function DPSMate.Modules.DetailsLiftMagicReceived:EvalTable(cname)
...
function DPSMate.Modules.DetailsLiftMagicReceived:ScrollFrame_Update(comp)
	comp = comp or DPSMate_Details_LiftMagicReceived.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."LiftMagicReceived_Log_ScrollFrame")
	local path = "DPSMate_Details_"..comp.."LiftMagicReceived_Log_ScrollButton"
...
function DPSMate.Modules.DetailsLiftMagicReceived:SelectCreatureButton(i, comp)
	comp = comp or DPSMate_Details_LiftMagicReceived.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."LiftMagicReceived_LogTwo_ScrollFrame")
	i = i or obj.index
	obj.index = i
	local path = "DPSMate_Details_"..comp.."LiftMagicReceived_LogTwo_ScrollButton"
	local uArr, dArr, dTot, dSel = DetailsArr, DmgArr, DetailsTotal, DetailsSelected
	if comp ~= "" and comp then
		uArr = DetailsArrComp
		dArr = DmgArrComp
	...
	for p=1, 14 do
		_G("DPSMate_Details_"..comp.."LiftMagicReceived_Log_ScrollButton"..p.."_selected"):Hide()
	end
	_G(path.."1_selected"):Show()
	DPSMate.Modules.DetailsLiftMagicReceived:SelectCreatureAbilityButton(i, 1, comp)
	_G("DPSMate_Details_"..comp.."LiftMagicReceived_Log_ScrollButton"..i.."_selected"):Show()
end

function DPSMate.Modules.DetailsLiftMagicReceived:SelectCreatureAbilityButton(i, p, comp)
	comp = comp or DPSMate_Details_LiftMagicReceived.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."LiftMagicReceived_LogThree_ScrollFrame")
	i = i or _G("DPSMate_Details_"..comp.."LiftMagicReceived_LogTwo_ScrollFrame").index
	p = p or obj.index
	obj.index = p
	local path = "DPSMate_Details_"..comp.."LiftMagicReceived_LogThree_ScrollButton"
	local uArr, dArr, dTot, dSel = DetailsArr, DmgArr, DetailsTotal, DetailsSelected
	if comp ~= "" and comp then
		uArr = DetailsArrComp
		dArr = DmgArrComp
	...
	for i=1, 14 do
		_G("DPSMate_Details_"..comp.."LiftMagicReceived_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	_G("DPSMate_Details_"..comp.."LiftMagicReceived_LogTwo_ScrollButton"..p.."_selected"):Show()
end