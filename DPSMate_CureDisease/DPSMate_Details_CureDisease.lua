-- Global Variables
DPSMate.Modules.DetailsCureDisease = {}
...
function DPSMate.Modules.DetailsCureDisease:UpdateDetails(obj, key)
	DPSMate_Details_CompareCureDisease:Hide()
	
	curKey = key
	db, cbt = DPSMate:GetMode(key)
	DetailsUser = obj.user
	DetailsUserComp = nil
	DPSMate_Details_CureDisease_Title:SetText(DPSMate.L["diseasecuredby"]..obj.user)
	DetailsArr, DetailsTotal, DmgArr = self:EvalTable()
	DPSMate_Details_CureDisease:Show()
	self:ScrollFrame_Update("")
	self:SelectCreatureButton(1,"")
	self:SelectCreatureAbilityButton(1,1,"")
	
	DPSMate_Details_CureDisease:SetScale((DPSMateSettings["targetscale"] or 0.58)/UIParent:GetScale())
end
...
function DPSMate.Modules.DetailsCureDisease:UpdateCompare(obj, key, comp)
	...
	DPSMate_Details_CompareCureDisease_Title:SetText(DPSMate.L["diseasecuredby"]..comp)
	DetailsArrComp, DetailsTotalComp, DmgArrComp = self:EvalTable(comp)
	DPSMate_Details_CompareCureDisease:Show()
...
function DPSMate.Modules.DetailsCureDisease:ScrollFrame_Update(comp)
	comp = comp or DPSMate_Details_CureDisease.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."CureDisease_Log_ScrollFrame")
	local path = "DPSMate_Details_"..comp.."CureDisease_Log_ScrollButton"
...
function DPSMate.Modules.DetailsCureDisease:SelectCreatureButton(i, comp)
	comp = comp or DPSMate_Details_CureDisease.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."CureDisease_LogTwo_ScrollFrame")
	i = i or obj.index
	obj.index = i
	local path = "DPSMate_Details_"..comp.."CureDisease_LogTwo_ScrollButton"
	local uArr, dArr, dTot = DetailsArr, DmgArr, DetailsTotal
	if comp~="" and comp then
		uArr = DetailsArrComp
		dArr = DmgArrComp
	...
	for p=1, 14 do
		_G("DPSMate_Details_"..comp.."CureDisease_Log_ScrollButton"..p.."_selected"):Hide()
	end
	_G(path.."1_selected"):Show()
	DPSMate.Modules.DetailsCureDisease:SelectCreatureAbilityButton(i, 1, comp)
	_G("DPSMate_Details_"..comp.."CureDisease_Log_ScrollButton"..i.."_selected"):Show()
end

function DPSMate.Modules.DetailsCureDisease:SelectCreatureAbilityButton(i, p, comp)
	comp = comp or DPSMate_Details_CureDisease.LastScroll
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_"..comp.."CureDisease_LogThree_ScrollFrame")
	i = i or _G("DPSMate_Details_"..comp.."CureDisease_LogTwo_ScrollFrame").index
	p = p or obj.index
	obj.index = p
	local path = "DPSMate_Details_"..comp.."CureDisease_LogThree_ScrollButton"
	local uArr, dArr, dTot = DetailsArr, DmgArr, DetailsTotal
	if comp~="" and comp then
		uArr = DetailsArrComp
		dArr = DmgArrComp
	...
	for i=1, 14 do
		_G("DPSMate_Details_"..comp.."CureDisease_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	_G("DPSMate_Details_"..comp.."CureDisease_LogTwo_ScrollButton"..p.."_selected"):Show()
end