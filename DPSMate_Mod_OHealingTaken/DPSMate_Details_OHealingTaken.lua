...
function DPSMate.Modules.DetailsOHealingTaken:SelectDetailsButton(p,i, comp, cname)
	...
	_G("DPSMate_Details_"..comp.."OHealingTaken_LogDetails_Average1"):SetText(ceil(hitav))
	...
	_G("DPSMate_Details_"..comp.."OHealingTaken_LogDetails_Average2"):SetText(ceil(critav))
