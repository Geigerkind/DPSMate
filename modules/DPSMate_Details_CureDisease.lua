...
function DPSMate.Modules.DetailsCureDisease:ScrollFrame_Update()
	...
	local obj = _G("DPSMate_Details_CureDisease_Log_ScrollFrame")
...
function DPSMate.Modules.DetailsCureDisease:SelectCreatureButton(i)
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_CureDisease_LogTwo_ScrollFrame")
	obj.index = i
	...
	for p=1, 14 do
		_G("DPSMate_Details_CureDisease_Log_ScrollButton"..p.."_selected"):Hide()
	end
	_G(path.."1_selected"):Show()
	self:SelectCreatureAbilityButton(i, 1)
	_G("DPSMate_Details_CureDisease_Log_ScrollButton"..i.."_selected"):Show()
end

function DPSMate.Modules.DetailsCureDisease:SelectCreatureAbilityButton(i, p)
	local line, lineplusoffset
	local obj = _G("DPSMate_Details_CureDisease_LogThree_ScrollFrame")
	obj.index = i
	...
	for i=1, 14 do
		_G("DPSMate_Details_CureDisease_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	_G("DPSMate_Details_CureDisease_LogTwo_ScrollButton"..p.."_selected"):Show()
end