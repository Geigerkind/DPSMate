...
function DPSMate.Modules.DetailsCureDisease:UpdateDetails(obj, key)
	...
	DPSMate_Details_CureDisease_Title:SetText("Disease cured by "..obj.user)
	DPSMate_Details_CureDisease:Show()
	DPSMate.Modules.DetailsCureDisease:ScrollFrame_Update()
	DPSMate.Modules.DetailsCureDisease:SelectCreatureButton(1)
	DPSMate.Modules.DetailsCureDisease:SelectCreatureAbilityButton(1,1)
end

function DPSMate.Modules.DetailsCureDisease:EvalTable()
	local a, b, total = {}, {}, 0
...
function DPSMate.Modules.DetailsCureDisease:ScrollFrame_Update()
	local line, lineplusoffset
	local obj = getglobal("DPSMate_Details_CureDisease_Log_ScrollFrame")
	local path = "DPSMate_Details_CureDisease_Log_ScrollButton"
	DetailsArr, DetailsTotal, DmgArr = DPSMate.Modules.DetailsCureDisease:EvalTable()
...
function DPSMate.Modules.DetailsCureDisease:SelectCreatureButton(i)
	local line, lineplusoffset
	local obj = getglobal("DPSMate_Details_CureDisease_LogTwo_ScrollFrame")
	obj.index = i
	local path = "DPSMate_Details_CureDisease_LogTwo_ScrollButton"
	...
	for p=1, 14 do
		getglobal("DPSMate_Details_CureDisease_Log_ScrollButton"..p.."_selected"):Hide()
	end
	getglobal(path.."1_selected"):Show()
	DPSMate.Modules.DetailsCureDisease:SelectCreatureAbilityButton(i, 1)
	getglobal("DPSMate_Details_CureDisease_Log_ScrollButton"..i.."_selected"):Show()
end

function DPSMate.Modules.DetailsCureDisease:SelectCreatureAbilityButton(i, p)
	local line, lineplusoffset
	local obj = getglobal("DPSMate_Details_CureDisease_LogThree_ScrollFrame")
	obj.index = i
	local path = "DPSMate_Details_CureDisease_LogThree_ScrollButton"
	...
	for i=1, 14 do
		getglobal("DPSMate_Details_CureDisease_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	getglobal("DPSMate_Details_CureDisease_LogTwo_ScrollButton"..p.."_selected"):Show()
end