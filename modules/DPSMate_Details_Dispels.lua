...
function DPSMate.Modules.DetailsDispels:ScrollFrame_Update()
	...
	local obj = DPSMate_Details_Dispels_Log_ScrollFrame
...
function DPSMate.Modules.DetailsDispels:SelectCreatureButton(i)
	local line, lineplusoffset
	local obj = DPSMate_Details_Dispels_LogTwo_ScrollFrame
	i = i or obj.index
	obj.index = i
	...
	for p=1, 14 do
		_G("DPSMate_Details_Dispels_Log_ScrollButton"..p.."_selected"):Hide()
	end
	_G(path.."1_selected"):Show()
	DPSMate.Modules.DetailsDispels:SelectCreatureAbilityButton(i, 1)
	_G("DPSMate_Details_Dispels_Log_ScrollButton"..i.."_selected"):Show()
end

function DPSMate.Modules.DetailsDispels:SelectCreatureAbilityButton(i, p)
	local line, lineplusoffset
	local obj = DPSMate_Details_Dispels_LogThree_ScrollFrame
	i = i or DPSMate_Details_Dispels_LogTwo_ScrollFrame.index
	p = p or obj.index
	obj.index = p
	...
	for i=1, 14 do
		_G("DPSMate_Details_Dispels_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	_G("DPSMate_Details_Dispels_LogTwo_ScrollButton"..p.."_selected"):Show()
end