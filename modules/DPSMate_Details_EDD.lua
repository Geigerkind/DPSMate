...
function DPSMate.Modules.DetailsEDD:SelectDetailsButton(p,i, comp, cname)
	...
	_G("DPSMate_Details_"..comp.."EDD_LogDetails_Average0"):SetText(ceil(blockav))
	...
	_G("DPSMate_Details_"..comp.."EDD_LogDetails_Average1"):SetText(ceil(crushav))
	...
	_G("DPSMate_Details_"..comp.."EDD_LogDetails_Average2"):SetText(ceil(hitav))
	...
	_G("DPSMate_Details_"..comp.."EDD_LogDetails_Average3"):SetText(ceil(critav))
