...
function DPSMate.Modules.DetailsEDD:UpdateStackedGraph()
	if not g then
...
function DPSMate.Modules.DetailsEDD:SortLineTable(arr, b)
	local newArr = {}
	if b then
...
function DPSMate.Modules.DetailsEDD:GetSummarizedTable(arr, b)
