...
function DPSMate.Modules.DetailsLiftMagic:ScrollFrame_Update()
	...
	local obj = DPSMate_Details_LiftMagic_Log_ScrollFrame
...
function DPSMate.Modules.DetailsLiftMagic:SelectCreatureButton(i)
	local line, lineplusoffset
	local obj = DPSMate_Details_LiftMagic_LogTwo_ScrollFrame
	i = i or obj.index
	obj.index = i
...
function DPSMate.Modules.DetailsLiftMagic:SelectCreatureAbilityButton(i, p)
	local line, lineplusoffset
	local obj = DPSMate_Details_LiftMagic_LogThree_ScrollFrame
	i = i or DPSMate_Details_LiftMagic_LogTwo_ScrollFrame.index
	p = p or obj.index
	obj.index = p
