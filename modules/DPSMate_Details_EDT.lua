...
function DPSMate.Modules.DetailsEDT:SelectDetailsButton(p,i, comp, cname)
	...
	_G("DPSMate_Details_"..comp.."EDT_LogDetails_Average0"):SetText(ceil(blockav))
	...
	_G("DPSMate_Details_"..comp.."EDT_LogDetails_Average1"):SetText(ceil(glanceav))
	...
	_G("DPSMate_Details_"..comp.."EDT_LogDetails_Average2"):SetText(ceil(hitav))
	...
	_G("DPSMate_Details_"..comp.."EDT_LogDetails_Average3"):SetText(ceil(critav))
