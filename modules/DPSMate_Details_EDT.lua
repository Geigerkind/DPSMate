...
function DPSMate.Modules.DetailsEDT:UpdateLineGraph()
	if not g2 then
		g2=DPSMate.Options.graph:CreateGraphLine("LineGraph",DPSMate_Details_EDT_DiagramLine,"CENTER","CENTER",0,0,850,230)
	end
	if g then
		g:Hide()
	end
...
function DPSMate.Modules.DetailsEDT:UpdateStackedGraph()
	if not g then
		g=DPSMate.Options.graph:CreateStackedGraph("StackedGraph",DPSMate_Details_EDT_DiagramLine,"CENTER","CENTER",0,0,850,230)
