...
function DPSMate.Modules.OHealingTaken:GetSettingValues(arr, cbt, k,ecbt)
	...
	for cat, val in pairs(sortedTable) do
		...
		if DPSMateSettings["columnsohealingtaken"][1] then str[1] = " "..va..p; strt[2] = " "..tot..p end
		if DPSMateSettings["columnsohealingtaken"][3] then str[2] = " ("..strformat("%.1f", 100*va/tot).."%)" end
