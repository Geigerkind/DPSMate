...
function DPSMate.Modules.DetailsCureDiseaseReceived:UpdateDetails(obj, key)
	...
	DPSMate.Modules.DetailsCureDiseaseReceived:ScrollFrame_Update()
	DPSMate.Modules.DetailsCureDiseaseReceived:SelectCreatureButton(1)
	DPSMate.Modules.DetailsCureDiseaseReceived:SelectCreatureAbilityButton(1,1)
end
...
function DPSMate.Modules.DetailsCureDiseaseReceived:ScrollFrame_Update()
	...
	local obj = getglobal("DPSMate_Details_CureDiseaseReceived_Log_ScrollFrame")
...
function DPSMate.Modules.DetailsCureDiseaseReceived:SelectCreatureButton(i)
	local line, lineplusoffset
	local obj = getglobal("DPSMate_Details_CureDiseaseReceived_LogTwo_ScrollFrame")
	obj.index = i
	...
	for p=1, 14 do
		getglobal("DPSMate_Details_CureDiseaseReceived_Log_ScrollButton"..p.."_selected"):Hide()
	end
	getglobal(path.."1_selected"):Show()
	DPSMate.Modules.DetailsCureDiseaseReceived:SelectCreatureAbilityButton(i, 1)
	getglobal("DPSMate_Details_CureDiseaseReceived_Log_ScrollButton"..i.."_selected"):Show()
end

function DPSMate.Modules.DetailsCureDiseaseReceived:SelectCreatureAbilityButton(i, p)
	local line, lineplusoffset
	local obj = getglobal("DPSMate_Details_CureDiseaseReceived_LogThree_ScrollFrame")
	obj.index = i
	...
	for i=1, 14 do
		getglobal("DPSMate_Details_CureDiseaseReceived_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	getglobal("DPSMate_Details_CureDiseaseReceived_LogTwo_ScrollButton"..p.."_selected"):Show()
end