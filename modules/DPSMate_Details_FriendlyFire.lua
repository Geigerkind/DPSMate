...
function DPSMate.Modules.DetailsFF:SelectDetailsButton(p,i)
	...
	_G("DPSMate_Details_FF_LogDetails_Amount2_Percent"):SetText(strformat("%.1f", 100*hit/total).."%")
	...
	_G("DPSMate_Details_FF_LogDetails_Amount3_Percent"):SetText(strformat("%.1f", 100*crit/total).."%")
	...
	_G("DPSMate_Details_FF_LogDetails_Amount4_Percent"):SetText(strformat("%.1f", 100*miss/total).."%")
	...
	_G("DPSMate_Details_FF_LogDetails_Amount5_Percent"):SetText(strformat("%.1f", 100*parry/total).."%")
	...
	_G("DPSMate_Details_FF_LogDetails_Amount6_Percent"):SetText(strformat("%.1f", 100*dodge/total).."%")
	...
	_G("DPSMate_Details_FF_LogDetails_Amount7_Percent"):SetText(strformat("%.1f", 100*resist/total).."%")
