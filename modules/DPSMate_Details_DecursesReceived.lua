...
function DPSMate.Modules.DetailsDecursesReceived:UpdateDetails(obj, key)
	...
	DPSMate.Modules.DetailsDecursesReceived:ScrollFrame_Update()
	DPSMate.Modules.DetailsDecursesReceived:SelectCreatureButton(1)
	DPSMate.Modules.DetailsDecursesReceived:SelectCreatureAbilityButton(1,1)
end
...
function DPSMate.Modules.DetailsDecursesReceived:ScrollFrame_Update()
	...
	local obj = getglobal("DPSMate_Details_DecursesReceived_Log_ScrollFrame")
...
function DPSMate.Modules.DetailsDecursesReceived:SelectCreatureButton(i)
	...
	for p=1, 14 do
		getglobal("DPSMate_Details_DecursesReceived_Log_ScrollButton"..p.."_selected"):Hide()
	end
	getglobal(path.."1_selected"):Show()
	DPSMate.Modules.DetailsDecursesReceived:SelectCreatureAbilityButton(i, 1)
	getglobal("DPSMate_Details_DecursesReceived_Log_ScrollButton"..i.."_selected"):Show()
end
...
function DPSMate.Modules.DetailsDecursesReceived:SelectCreatureAbilityButton(i, p)
	...
	for i=1, 14 do
		getglobal("DPSMate_Details_DecursesReceived_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	getglobal("DPSMate_Details_DecursesReceived_LogTwo_ScrollButton"..p.."_selected"):Show()
end