...
function DPSMate.Modules.DetailsCurePoison:UpdateDetails(obj, key)
	...
	DPSMate.Modules.DetailsCurePoison:ScrollFrame_Update()
	DPSMate.Modules.DetailsCurePoison:SelectCreatureButton(1)
	DPSMate.Modules.DetailsCurePoison:SelectCreatureAbilityButton(1,1)
end
...
function DPSMate.Modules.DetailsCurePoison:ScrollFrame_Update()
	...
	local obj = getglobal("DPSMate_Details_CurePoison_Log_ScrollFrame")
...
function DPSMate.Modules.DetailsCurePoison:SelectCreatureButton(i)
	local line, lineplusoffset
	local obj = getglobal("DPSMate_Details_CurePoison_LogTwo_ScrollFrame")
	obj.index = i
	...
	for p=1, 14 do
		getglobal("DPSMate_Details_CurePoison_Log_ScrollButton"..p.."_selected"):Hide()
	end
	getglobal(path.."1_selected"):Show()
	DPSMate.Modules.DetailsCurePoison:SelectCreatureAbilityButton(i, 1)
	getglobal("DPSMate_Details_CurePoison_Log_ScrollButton"..i.."_selected"):Show()
end

function DPSMate.Modules.DetailsCurePoison:SelectCreatureAbilityButton(i, p)
	local line, lineplusoffset
	local obj = getglobal("DPSMate_Details_CurePoison_LogThree_ScrollFrame")
	obj.index = i
	...
	for i=1, 14 do
		getglobal("DPSMate_Details_CurePoison_LogTwo_ScrollButton"..i.."_selected"):Hide()
	end
	getglobal("DPSMate_Details_CurePoison_LogTwo_ScrollButton"..p.."_selected"):Show()
end