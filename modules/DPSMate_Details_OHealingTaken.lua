...
function DPSMate.Modules.DetailsOHealingTaken:ScrollFrame_Update()
	local line, lineplusoffset
	local path = "DPSMate_Details_OHealingTaken_LogCreature"
...
function DPSMate.Modules.DetailsOHealingTaken:SelectCreatureButton(i)
	local line, lineplusoffset
	local path = "DPSMate_Details_OHealingTaken_Log"
	local obj = _G(path.."_ScrollFrame")
	...
	for p=1, 10 do
		_G("DPSMate_Details_OHealingTaken_LogCreature_ScrollButton"..p.."_selected"):Hide()
	end
	_G("DPSMate_Details_OHealingTaken_LogCreature_ScrollButton"..i.."_selected"):Show()
	DPSMate.Modules.DetailsOHealingTaken:SelectDetailsButton(i,1)
	if toggle3 then
		if toggle then
			self:UpdateStackedGraph()
		else
...
function DPSMate.Modules.DetailsOHealingTaken:SelectDetailsButton(p,i)
	local obj = DPSMate_Details_OHealingTaken_Log_ScrollFrame
	local lineplusoffset = i + FauxScrollFrame_GetOffset(obj)
	
	for p=1, 10 do
		_G("DPSMate_Details_OHealingTaken_Log_ScrollButton"..p.."_selected"):Hide()
	end
	-- Performance?
	local ability = tonumber(DmgArr[p][2][lineplusoffset])
	local creature = tonumber(DetailsArr[p])
	_G("DPSMate_Details_OHealingTaken_Log_ScrollButton"..i.."_selected"):Show()
	...
	-- Hit
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount1_Amount"):SetText(hit)
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount1_Percent"):SetText(strformat("%.1f", 100*hit/total).."%")
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount1_StatusBar"):SetValue(ceil(100*hit/max))
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount1_StatusBar"):SetStatusBarColor(1.0,0.7,0.3,1)
	_G("DPSMate_Details_OHealingTaken_LogDetails_Average1"):SetText(ceil(hitav))
	_G("DPSMate_Details_OHealingTaken_LogDetails_Min1"):SetText(hitMin)
	_G("DPSMate_Details_OHealingTaken_LogDetails_Max1"):SetText(hitMax)
	
	-- Crit
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount2_Amount"):SetText(crit)
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount2_Percent"):SetText(strformat("%.1f", 100*crit/total).."%")
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount2_StatusBar"):SetValue(ceil(100*crit/max))
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount2_StatusBar"):SetStatusBarColor(0.9,0.0,0.0,1)
	_G("DPSMate_Details_OHealingTaken_LogDetails_Average2"):SetText(ceil(critav))
	_G("DPSMate_Details_OHealingTaken_LogDetails_Min2"):SetText(critMin)
	_G("DPSMate_Details_OHealingTaken_LogDetails_Max2"):SetText(critMax)
end
...
function DPSMate.Modules.DetailsOHealingTaken:CreateGraphTable()
	local lines = {}
	for i=1, 8 do
		-- Horizontal
		lines[i] = DPSMate.Options.graph:DrawLine(DPSMate_Details_OHealingTaken_Log, 252, 270-i*30, 617, 270-i*30, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
		lines[i]:Show()
	end
	-- Vertical
	lines[9] = DPSMate.Options.graph:DrawLine(DPSMate_Details_OHealingTaken_Log, 302, 260, 302, 15, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[9]:Show()
	
	lines[10] = DPSMate.Options.graph:DrawLine(DPSMate_Details_OHealingTaken_Log, 437, 260, 437, 15, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[10]:Show()
	
	lines[11] = DPSMate.Options.graph:DrawLine(DPSMate_Details_OHealingTaken_Log, 497, 260, 497, 15, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[11]:Show()
	
	lines[12] = DPSMate.Options.graph:DrawLine(DPSMate_Details_OHealingTaken_Log, 557, 260, 557, 15, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[12]:Show()
end

function DPSMate.Modules.DetailsOHealingTaken:SortLineTable(t,b)
	local newArr = {}
	if b then
...
function DPSMate.Modules.DetailsOHealingTaken:GetSummarizedTable(arr,b)
