...
function DPSMate.Modules.DetailsOHealingTaken:SelectDetailsButton(p,i)
	...
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount1_Percent"):SetText(ceil(100*hit/total).."%")
	...
	_G("DPSMate_Details_OHealingTaken_LogDetails_Amount2_Percent"):SetText(ceil(100*crit/total).."%")
