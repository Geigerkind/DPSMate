...
function DPSMate.Modules.DetailsEHealing:UpdateCompare(obj, key, comp)
	...
	DPSMate_Details_CompareEHealing_SubTitle:SetText(DPSMate.L["activity"]..strformat("%.2f", DPSMateCombatTime["effective"][key][comp] or 0).."s "..DPSMate.L["of"].." "..strformat("%.2f", cbt).."s ("..strformat("%.2f", 100*(DPSMateCombatTime["effective"][key][comp] or 0)/cbt).."%)")
...
function DPSMate.Modules.DetailsEHealing:SelectDetails_EHealingButton(i, comp, cname)
	...
	_G("DPSMate_Details_"..comp.."EHealing_LogDetails_EHealing_Average0"):SetText(ceil(hitav/DPSMate:ProbZero(hit)))
	...
	_G("DPSMate_Details_"..comp.."EHealing_LogDetails_EHealing_Average1"):SetText(ceil(critav/DPSMate:ProbZero(crit)))
