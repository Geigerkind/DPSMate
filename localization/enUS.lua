...
DPSMate.localization.memory = "DPSMate has collected a lot of data. This will cause screen lag during the data saving process upon logout. Do you want to reset DPSMate first?"
...
DPSMate.localization.config.broadcasting = "Broadcasting options"
...
DPSMate.localization.config.testmode = "Test mode"
...
DPSMate.localization.config.mergepets = "Merge pets"
...
DPSMate.localization.config.procs = "Procs"
DPSMate.localization.details.switch = "Switch mode"
...
DPSMate.localization.config.threat = "Threat"
DPSMate.localization.config.tps = "TPS"
DPSMate.localization.config.fails = "Fails"
DPSMate.localization.config.cat = "Category"
DPSMate.localization.config.ccbreaker = "CCBreaker"
...
DPSMate.localization.config.dataresetslogout = "Logout reset request"
DPSMate.localization.config.dataresetslogouttooltip = "Reset on logout"
DPSMate.localization.config.enabledisable = "Enable/Disable"
DPSMate.localization.config.bgbarcolor = "Background bar color"
DPSMate.localization.config.bgbarcolorTooltip = "Click to choose a background bar color."
...
DPSMate.localization.config.casts = "Casts"