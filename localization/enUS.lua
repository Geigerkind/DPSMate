...
DPSMate.localization.config.scaleTooltio = "Move this to change the scale of DPSMate."
...
DPSMate.localization.config.whatisdpsmateText = "DPSMate is a combat analyzing tool. It provides a lot of functions to review the fight as good as possible. By this information gameplay improvements are easy to evaluate."
